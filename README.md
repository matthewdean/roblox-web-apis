ATTN: all of the information in this repository has been gathered using Google and nslookup, nothing else (except for the sitemap, that was largely generated by levi). No insider information has been used.
